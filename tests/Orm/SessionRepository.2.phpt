...
$repo->clear();
$repo->session[__NAMESPACE__ . '\\TestEntity'] = array(
		SessionRepository::NO_ID => array('id' => null, 'name' => 'foo', 'related' => SessionRepository::NO_ID)
);

$repo->session[__NAMESPACE__ . '\\RelatedEntity'] = array(
...
Assert::arrayEqual(array(
		SessionRepository::NO_ID => array('id' => null, 'name' => 'bar', 'related' => SessionRepository::NO_ID)
