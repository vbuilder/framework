...
class ConfigDAO implements \ArrayAccess {
	...
	/**
	 * @var bool status of last ::get call, if true, everything went ok, if false
	...
	/**
	 * Deletes all cached DAO objects and purges data.
	...
	public function set($key, $value) {
		...
		if(!is_scalar($value))
			throw new \InvalidArgumentException("Non-scalar values are not allowed.");
