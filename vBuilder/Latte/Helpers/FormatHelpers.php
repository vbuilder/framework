...
class FormatHelpers {
	...
	public static function formatPostalCode($value) {
	...
	/**
	 * @todo make translatable move to vBuilder\Utils\DateTime with helper in vBuilder\Latte\Helpers\DateFormatHelpers
	 */
